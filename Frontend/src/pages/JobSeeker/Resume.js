...
function Resume(props) {
    ...
    const[expandContact, setExpandContact] = useState()
    ...
    return (
        <div>
            ...
            <p></p>
            <p style={{textAlign:'center'}}><b><u style={{color:'blue'}} onClick={hideResumeUpdate} hidden={hideSkip}>Skip for now</u></b></p>
        </div>
    )
}
