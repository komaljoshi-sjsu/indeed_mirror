        ...
        if(Object.keys(data).length>0) {
            ...
            axios.post(backendServer+'/api/updateJobSeekerProfile',{
                ...
                if(res.data.code == '200') {
                    ...
                    if(email!=emailId) {
                        showSuccessModal(true);
                        setErrMsg('Successfully updated user data. Since you changed email, you will be logged out. Please login again.');
                        setTimeout(function () {
                            logout(true);
        ...
        if(fileUploaded!=null) {
            ...
            axios.post(backendServer+'/api/uploadResume/'+id,data).then(res=>{
                ...
                if(res.data.code=='200') {
                    ...
                    setNoResume(false);
                    hideResumeUpdate();
                    if(res.data.location!=null && res.data.location.trim().length>0)  {
