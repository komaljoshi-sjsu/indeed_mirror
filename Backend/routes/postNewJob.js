...
router.post("/postNewJob", (req, res) => {
	...
	let postJob_sql = 'INSERT INTO Job(companyId, jobTitle, streetAddress, city, state, country, zip, salaryDetails, shortJobDescription, jobType, jobMode, companyName,industry,responsibilities,qualifications,loveJobRole, jobPostedDate) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,CURDATE())';
